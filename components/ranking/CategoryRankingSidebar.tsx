...
export default function CategoryRankingSidebar({ rankings }: CategoryRankingSidebarProps) {
  ...
  return (
    <div className="rounded-xl border border-border bg-white p-4">
      ...
      <Link
        href="/rankings"
        className="mt-3 flex items-center justify-center rounded-lg bg-gray-50 py-2 text-xs font-medium text-primary hover:bg-primary-light/40 transition-colors"
      >
        전체 랭킹 보기 →
      </Link>
    </div>
